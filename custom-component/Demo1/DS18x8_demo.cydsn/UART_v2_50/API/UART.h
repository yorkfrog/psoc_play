...
/* Only if TX is enabled */
    ...
    void `$INSTANCE_NAME`_PutArray(const uint8 string[], `$TxBuffRegSizeReplacementString` byteCount)
...
/* Status Register definitions */
#if( (`$INSTANCE_NAME`_TX_ENABLED) || (`$INSTANCE_NAME`_HD_ENABLED) )
    #if(`$INSTANCE_NAME`_TX_INTERRUPT_ENABLED)
        #define `$INSTANCE_NAME`_TX_VECT_NUM            (uint8)`$INSTANCE_NAME`_TXInternalInterrupt__INTC_NUMBER
        #define `$INSTANCE_NAME`_TX_PRIOR_NUM           (uint8)`$INSTANCE_NAME`_TXInternalInterrupt__INTC_PRIOR_NUM
    #endif /* `$INSTANCE_NAME`_TX_INTERRUPT_ENABLED */
    ...
    #define `$INSTANCE_NAME`_TX_STS_COMPLETE            (uint8)(0x01u << `$INSTANCE_NAME`_TX_STS_COMPLETE_SHIFT)
    #define `$INSTANCE_NAME`_TX_STS_FIFO_EMPTY          (uint8)(0x01u << `$INSTANCE_NAME`_TX_STS_FIFO_EMPTY_SHIFT)
    #define `$INSTANCE_NAME`_TX_STS_FIFO_FULL           (uint8)(0x01u << `$INSTANCE_NAME`_TX_STS_FIFO_FULL_SHIFT)
    #define `$INSTANCE_NAME`_TX_STS_FIFO_NOT_FULL       (uint8)(0x01u << `$INSTANCE_NAME`_TX_STS_FIFO_NOT_FULL_SHIFT)
#endif /* End (`$INSTANCE_NAME`_TX_ENABLED) || (`$INSTANCE_NAME`_HD_ENABLED)*/

#if( (`$INSTANCE_NAME`_RX_ENABLED) || (`$INSTANCE_NAME`_HD_ENABLED) )
    #if(`$INSTANCE_NAME`_RX_INTERRUPT_ENABLED)
        #define `$INSTANCE_NAME`_RX_VECT_NUM            (uint8)`$INSTANCE_NAME`_RXInternalInterrupt__INTC_NUMBER
        #define `$INSTANCE_NAME`_RX_PRIOR_NUM           (uint8)`$INSTANCE_NAME`_RXInternalInterrupt__INTC_PRIOR_NUM
    #endif /* `$INSTANCE_NAME`_RX_INTERRUPT_ENABLED */
    ...
    #define `$INSTANCE_NAME`_RX_STS_MRKSPC           (uint8)(0x01u << `$INSTANCE_NAME`_RX_STS_MRKSPC_SHIFT)
    #define `$INSTANCE_NAME`_RX_STS_BREAK            (uint8)(0x01u << `$INSTANCE_NAME`_RX_STS_BREAK_SHIFT)
    #define `$INSTANCE_NAME`_RX_STS_PAR_ERROR        (uint8)(0x01u << `$INSTANCE_NAME`_RX_STS_PAR_ERROR_SHIFT)
    #define `$INSTANCE_NAME`_RX_STS_STOP_ERROR       (uint8)(0x01u << `$INSTANCE_NAME`_RX_STS_STOP_ERROR_SHIFT)
    #define `$INSTANCE_NAME`_RX_STS_OVERRUN          (uint8)(0x01u << `$INSTANCE_NAME`_RX_STS_OVERRUN_SHIFT)
    #define `$INSTANCE_NAME`_RX_STS_FIFO_NOTEMPTY    (uint8)(0x01u << `$INSTANCE_NAME`_RX_STS_FIFO_NOTEMPTY_SHIFT)
    #define `$INSTANCE_NAME`_RX_STS_ADDR_MATCH       (uint8)(0x01u << `$INSTANCE_NAME`_RX_STS_ADDR_MATCH_SHIFT)
    #define `$INSTANCE_NAME`_RX_STS_SOFT_BUFF_OVER   (uint8)(0x01u << `$INSTANCE_NAME`_RX_STS_SOFT_BUFF_OVER_SHIFT)
...
#define `$INSTANCE_NAME`_CTRL_HD_SEND               (uint8)(0x01u << `$INSTANCE_NAME`_CTRL_HD_SEND_SHIFT)
#define `$INSTANCE_NAME`_CTRL_HD_SEND_BREAK         (uint8)(0x01u << `$INSTANCE_NAME`_CTRL_HD_SEND_BREAK_SHIFT)
#define `$INSTANCE_NAME`_CTRL_MARK                  (uint8)(0x01u << `$INSTANCE_NAME`_CTRL_MARK_SHIFT)
#define `$INSTANCE_NAME`_CTRL_PARITY_TYPE_MASK      (uint8)(0x03u << `$INSTANCE_NAME`_CTRL_PARITY_TYPE0_SHIFT)
#define `$INSTANCE_NAME`_CTRL_RXADDR_MODE_MASK      (uint8)(0x07u << `$INSTANCE_NAME`_CTRL_RXADDR_MODE0_SHIFT)
...
extern uint8 `$INSTANCE_NAME`_initVar;
    ...
    extern volatile uint8 `$INSTANCE_NAME`_txBuffer[`$INSTANCE_NAME`_TX_BUFFER_SIZE];
    ...
    extern uint8 `$INSTANCE_NAME`_errorStatus;
    extern volatile uint8 `$INSTANCE_NAME`_rxBuffer[`$INSTANCE_NAME`_RX_BUFFER_SIZE];
...
#define `$INSTANCE_NAME`_INIT_RX_INTERRUPTS_MASK \
                                  (uint8)((`$InterruptOnByteRcvd` << `$INSTANCE_NAME`_RX_STS_FIFO_NOTEMPTY_SHIFT) \
...
#define `$INSTANCE_NAME`_INIT_TX_INTERRUPTS_MASK \
                                  (uint8)((`$InterruptOnTXComplete` << `$INSTANCE_NAME`_TX_STS_COMPLETE_SHIFT) \
